...
class BatteryParser:
    def __init__(self):
        ...
        self.test_frame = bytes.fromhex(
            "DD 03 00 1B 15 57 00 00 05 A8 05 A8 00 07 2F 61 00 00 00 00 00 00 23 64 03 0D 02 0B BF 0B AA FB 70 77 "
            #"DD 03 00 1B 15 5F 00 35 05 A8 05 A8 00 07 2F 61 14 01 00 00 00 00 23 64 03 0D 02 0B BF 0B AA FB 1E 77 "
            # "DD 03 00 1B 12 A2 00 00 02 CD 05 A8 00 07 2F 61 00 00 00 00 00 00 23 32 03 0D 02 0B 7D 0B 79 FB AB 77 "
