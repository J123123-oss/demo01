...
class BatteryParser:
    def __init__(self):
        ...
        self.test_frame = bytes.fromhex(
            "DD 03 00 26 14 9E 00 00 04 AB 07 D0 00 1D 33 0F 00 00 00 00 00 00 A1 3C 03 0D 03 0A C1 0A C9 0A C4 00 00 00 07 D0 04 AB 00 03 F8 5E 77"
            # "DD 03 00 26 14 C3 00 35 03 C1 07 D0 00 1E 33 0F 00 00 00 00 00 00 A1 30 03 0D 03 0A AB 0A B1 0A B5 00 00 00 07 D0 03 C1 00 03 F8 22 77"
            # "DD 03 00 26 14 B3 00 00 03 C3 07 D0 00 1E 33 0F 00 00 00 00 00 00 A1 30 03 0D 03 0A B2 0A B7 0A B8 00 00 00 07 D0 03 C3 00 03 F8 53 77"
            # "DD 03 00 26 14 B3 00 00 03 C3 07 D0 00 1E 33 0F 00 00 00 00 00 00 A1 30 03 0D 03 0A B2 0A B7 0A B8 00 00 00 07 D0 03 C3 00 03 F8 53 77"
            # "DD 03 00 1B 15 3B 00 00 05 A8 05 A8 00 06 2F 61 00 00 00 00 00 00 23 64 03 0D 02 0B AC 0B 9C FB AE 77 "
            # "DD 03 00 1B 15 3B 00 00 05 A8 05 A8 00 06 2F 61 00 00 00 00 00 00 23 64 03 0D 02 0B AC 0B 9C FB AE 77 "
            # "DD 03 00 26 13 D0 00 00 00 59 01 EA 00 01 32 8B 00 00 00 00 00 00 24 14 03 0D 03 0B 5F 0B 56 0B 55 00 00 00 01 B9 00 59 00 2F FA 3D 77"
            # "DD 03 00 26 13 9B 00 00 01 5B 01 EA 00 01 32 8B 00 00 00 00 00 00 24 47 03 0D 03 0B 93 0B 89 0B 88 00 00 00 01 EA 01 5B 00 00 F9 9D 77 "
