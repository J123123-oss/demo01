...
class ServoDriveController:
    ...
    # def __init__(self, channel='can0', interface='socketcan'):
        ...
        self.status_config = {
            ...
            "FORWARD": {  # 前进状态
                "velocity_left": 50 * rate,
                "velocity_right": 50 * rate,
        ...
        self.current_velocity_left = 0   # ID = 3
        self.current_velocity_right = 0  # ID = 2
    ...
    def set_state(self, new_state):
        ...
        # 设置速度
        self.current_velocity_left = config["velocity_left"]
        self.current_velocity_right = config["velocity_right"]
        self.current_velocity_brush = config["velocity_brush"]

        # 应用到电机
        self.set_target_velocity(2, self.current_velocity_left)
        self.set_target_velocity(3, self.current_velocity_right)
    ...
    def publish_state(self):
        ...
        state_msg = {
            ...
            "velocity_left": self.current_velocity_left / rate,  # 单位转换为RPM
            "velocity_right": self.current_velocity_right / rate,
    ...
    def status_callback(self, msg):
        ...
        #         self.current_velocity_left = self.stop_velocity
        #         self.current_velocity_right = self.stop_velocity
        #         self.current_velocity_brush = self.stop_velocity
        #         self.publish_state()
        #     elif self.current_status == "FORWARD":
        #         self.current_velocity_left = int(50 * rate)
        #         self.current_velocity_right = int(50 * rate)
    ...
    def distance_callback(self, msg):
        """超声波距离检测回调"""
        if msg.distance_a < 30 and self.current_status in ["FORWARD", "BACKWARD"]:
            self.set_state("STOP")
    ...
    def execute_state(self, event=None):
        ...
        #         self.current_velocity_right = self.stop_velocity
        #         self.current_velocity_brush = self.stop_velocity
        #         self.set_target_velocity(2, current_velocity_left)
        #         self.set_target_velocity(3, current_velocity_right)
        ...
        #         self.current_velocity_brush = int(1200*rate)
        #         self.set_target_velocity(2, self.current_velocity_left)
        #         self.set_target_velocity(3, self.current_velocity_left)
        #         self.set_target_velocity(4, self.current_velocity_brush)
        #         self.publish_state()
        #         self.last_state = self.current_status
        #
